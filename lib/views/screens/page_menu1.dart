...
class _PageMenu1State extends State<PageMenu1> {
                    ...
                    Align(
                      ...
                      child: Column(
                        children: [
                          ...
                          _community(context),
                          Container(
                            margin: EdgeInsets.only(left: 12.0, bottom: 30.0, right: 12.0, top: 15.0),
                            child: Row(
                              children: [
                                _menu1(context),
                                _menu2(context),
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 12.0, bottom: 60.0, right: 12.0, top: 10.0),
                            child: Row(
                              children: [
                                _menu5(context),
                                _menu6(context), 
  ...
  Widget _news(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(left: 16.0, bottom: 10.0, right: 16.0),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Container(
  ...
  Widget _community(context) {
    return Container(
      margin: EdgeInsets.only(top: 10.0, left: 16.0, bottom: 10.0, right: 16.0),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Container(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset("assets/ic_ynci.png"),
                ]
              ),
            ),
          ),
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset("assets/ic_youtube.png"),
                ]
              ),
            ),
          ),
